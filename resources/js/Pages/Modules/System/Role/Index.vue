                                ...
                                >
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        <Link
                                            ...
                                            "
                                            class="font-medium text-sky-600 dark:text-red-500 hover:underline mr-4"
                                            >Permissions
                                        </Link>
                                        <a
                                            role="button"
                                            @click="
                                                confirmDeletion(role.hashed_id)
                                            "
...
watch(
    ...
    debounce(
        (q) =>
            router.get("/system/role", { search: q }, { preserveState: true }),
        500
    )
);
