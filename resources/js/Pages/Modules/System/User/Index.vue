<template>
    <AppLayout title="User">
        ...
        <DialogModal :show="confirmingDeletion" @close="closeModal">
            <template #title> Delete User Account </template>
...
watch(
    ...
    debounce(
        (q) =>
            router.get("/system/user", { search: q }, { preserveState: true }),
        500
    )
);
