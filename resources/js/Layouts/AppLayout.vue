    ...
    <div>
        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            >
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div
                                ...
                                v-if="$page.props.isSuperAdmin || $page.props.isAdmin"
                            >
                                <NavLink
                            ...
                            >
                                <button
                                    id="modules-menu-full-dropdown-button"
                                    @click="toggleMenu('modules')"
                                    :data-collapse-toggle="
                                        openMenu === 'modules'
                                            ? 'modules-menu-full-dropdown'
                                            : null
                                    "
                                    :class="classes"
                                >
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            ...
                            <div class="flex flex-row items-center">
                                <!-- Theme Toggle -->
                                <ThemeToggle
                                    class="me-5 text-black dark:text-white"
                                />
                                <!-- Settings Dropdown -->
                                <div class="ms-3 relative">
                ...
                <!-- System Modules Menu -->
                <div
                    id="modules-menu-full-dropdown"
                    :class="{ hidden: openMenu !== 'modules' }"
                    class="mt-1 bg-white border-gray-200 shadow-sm border-y dark:bg-gray-800 dark:border-gray-600"
                >
                    <div
                        class="grid max-w-screen-xl px-4 py-5 mx-auto text-gray-900 dark:text-white sm:grid-cols-2 md:grid-cols-4 md:px-6"
                    >
                        ...
                        <ul aria-labelledby="modules-menu-full-dropdown-button" v-if="$page.props.isSuperAdmin">
                            ...
                            >
                                ...
                                <span
                                    class="text-sm text-gray-500 dark:text-gray-400"
                                    >Manage System Permissions.</span
                                >
                            </NavLinkMenu>
                        </ul>
                        <ul aria-labelledby="modules-menu-full-dropdown-button" v-if="$page.props.isSuperAdmin">
